  ...
  return (
    <BackgroundSection>
      <div className="h-full max-w-full px-0 sm:px-0 md:px-40 lg:px-40 xl:px-40">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-10 mt-10 justify-items-center">
          {aboutIndustryData3 &&
            aboutIndustryData3?.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center flex flex-col items-center w-fit py-8 px-5 md:w-full lg:w-full xl:w-full relative z-20 ring-junglegreen-200 ring-1 p-1 rounded-xl bg-gradient-to-t from-onyx-900"
                >
                  {IconComponent && (
